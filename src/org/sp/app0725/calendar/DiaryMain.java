...
public class DiaryMain extends JFrame{
	...
	//탭메뉴 처리 
	TabMenu[] tab;
	Thread[] thread; //탭메뉴의 에니메이션을 구현할 쓰레드
	...
	public DiaryMain() {
		...
		//setBounds로 좌표에 의한 위치를 설정할 경우, 컨테이너엔 레이아웃 즉 배치관리자
		//가 적용되지 말아야 한다..
		...
		//객체차원까지 사용할 필요가있는가? 간단한 함수기반으로 작성하는 방법은 없는가?
		//람다표현식(Lambda) - 함수기반 언어에서 유래..
		//즉 거창하게 객체까지 필요없는 단순한 코드인경우 함수 수준으로 처리함이 더 코드량
		//이 적음..
	...
	public void printTitle() {
		...
		//출력시 2자리수 미만인 경우 즉 1자리수 인경우 숫자앞에 0을 붙이자
		//예)  7인 경우 --> 07 표현
	...
	public int getLastDateOfMonth() {
		//현재 보고 있는 월의 다음월 및 0일로 로 조작을 가한 후, 
		//몇일인지 물어보자 
